...
const AllSessionsView = () => {
    ...
    const { data: result, refetch, isFetching } = useQuery("allSessions", () => getAllSessions(selectedPage, rowsPerPage, dateRange));
    ...
    }, [rowsPerPage, selectedPage, dateRange])
            ...
            <div className="row mt-4">
                ...
                <div className="col-10 mx-auto">
                    <div className="d-flex justify-content-between">
                        <DateRangePickerComponent dateRange={dateRange} setDateRange={setDateRange}></DateRangePickerComponent>
